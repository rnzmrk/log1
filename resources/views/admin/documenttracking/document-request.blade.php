...
<div class="container-fluid px-6 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Document Request</h1>
    ...
    <div class="mt-8">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <a href="{{ route('admin.documenttracking.list-document-request') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                    View All →
                </a>
            </div>
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <form method="GET" action="{{ route('admin.documenttracking.document-request') }}" class="flex gap-4">
                    <!-- Search -->
                    <div class="flex-1">
                        <div class="relative">
                            <input type="text" 
                    ...
                    <!-- Status Filter -->
                    <div>
                        <select name="status" class="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <!-- Priority Filter -->
                    <div>
                        <select name="priority" class="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <a href="{{ route('admin.documenttracking.document-request') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2 px-4 rounded-lg transition-colors">
                        <i class='bx bx-x mr-2'></i>
                        Clear
                    </a>
                </form>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($requests as $request)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $request->document_type }}</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        ...
                                        @if(in_array($request->status, ['Draft', 'Submitted', 'Rejected']))
                                            <form action="{{ route('document-requests.destroy', $request->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this request?')" class="inline">
                                                @csrf
                                                @method('DELETE')
