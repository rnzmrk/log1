...
<div class="container-fluid px-6 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Create Supplier Post</h1>
            <p class="text-gray-600 mt-1">Create a new post about a supplier</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('admin.supplier.posts.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="category" 
                        ...
                        <option value="Featured Supplier" {{ old('category') == 'Featured Supplier' ? 'selected' : '' }}>Featured Supplier</option>
                    </select>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex-shrink-0">
                            <img id="imagePreview" src="https://via.placeholder.com/120x120/e5e7eb/6b7280?text=Image" alt="Image preview" class="h-30 w-30 object-cover rounded-lg border border-gray-300">
                        </div>
                        <div class="flex-1">
                            <input type="file" 
                                   id="image" 
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload post image (JPG, PNG, GIF - Max 2MB)</p>
            ...
            <div class="flex justify-end space-x-3 mt-8 pt-6 border-t border-gray-200">
                ...
                <button type="submit" class="px-6 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors duration-200 font-medium">
                    <i class='bx bx-save mr-2'></i>Create Post
                </button>
            </div>
        </form>
    </div>
