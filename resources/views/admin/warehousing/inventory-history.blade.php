...
<div class="container-fluid px-6 py-8">
    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <i class='bx bx-chevron-right text-gray-400'></i>
                    <span class="ml-1 text-gray-500 md:ml-2">Inventory History</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">View all inventory items with complete history and status tracking</p>
        </div>
        ...
        <form method="GET" action="{{ route('inventory.history') }}">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="relative">
                        <input type="text" 
                               ...
                               placeholder="Search by SKU, PO, Department, Supplier, or Item Name...">
                ...
                <div class="lg:col-span-3 flex gap-3">
                    ...
                    <a href="{{ route('inventory.history') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2 px-6 rounded-lg transition-colors flex items-center gap-2">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
        <div class="flex items-center justify-between">
            <div class="text-sm text-gray-600">
                ...
                <span class="font-medium">{{ $inventories->total() }}</span> items
            </div>
            @if (request()->hasAny(['search', 'status', 'department', 'supplier']))
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-8 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-lg font-medium">No inventory history found</p>
