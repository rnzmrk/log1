...
<div class="container-fluid px-6 py-8">
    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <i class='bx bx-chevron-right text-gray-400'></i>
                    <span class="ml-1 text-gray-500 md:ml-2">Outbound History</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Outbound Logistics History</h1>
            <p class="text-gray-600 mt-1">View all outbound shipments with complete history and status tracking</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <form method="GET" action="{{ route('outbound-logistics.history') }}">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="relative">
                        <input type="text" 
                               ...
                               placeholder="Search by Shipment ID, SKU, PO, Department, or Item Name...">
                ...
                <div class="lg:col-span-3 flex gap-3">
                    ...
                    <a href="{{ route('outbound-logistics.history') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2 px-6 rounded-lg transition-colors flex items-center gap-2">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
        <div class="flex items-center justify-between">
            <div class="text-sm text-gray-600">
                Showing <span class="font-medium">{{ $outboundLogistics->firstItem() }}</span> to 
                <span class="font-medium">{{ $outboundLogistics->lastItem() }}</span> of 
                <span class="font-medium">{{ $outboundLogistics->total() }}</span> shipments
            </div>
    ...
    <!-- Outbound Logistics History Table -->
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($outboundLogistics as $logistic)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                {{ $logistic->shipment_id ?? 'OUT-' . str_pad($logistic->id, 6, '0', STR_PAD_LEFT) }}
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                {{ $logistic->quantity ?? $logistic->stock ?? 0 }} units
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @elseif ($logistic->status === 'Ready to Ship')
                                    <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                        Ready to Ship
                                    </span>
                                @elseif ($logistic->status === 'Shipped')
                                ...
                                @elseif ($logistic->status === 'Cancelled')
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-8 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-lg font-medium">No outbound history found</p>
